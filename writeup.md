...
| Adam optimizer | Error minimizing was done using adam_optimizer based on adam algorythm, an extension of Stochastic Gradient Descent.|

#### 3. Describe how you trained your model. The discussion can include the type of optimizer, the batch size, number of epochs and any hyperparameters such as learning rate.

The table below describes the hyperparameters.
| Parameter name | Description	| Value | Tuning  |
|:--------------:|:-----------:|:-----:|:-------:|
|
